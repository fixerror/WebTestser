...
<!--<![endif]-->
	...
	<link rel="stylesheet" type="text/css" href="${context}/resources/css/bootstrap.css?v=${CSS_JS_VERSION}" />
...
<body class="style1">
	...
	<script src="${context}/resources/js/bootstrap.js?v=${CSS_JS_VERSION}"></script>
	<script>
