...
public class AdminControler extends AbstractController {
	...
	public String listAccount(Map<String, Object> map) {
		...
		map.put("admintList", adminService.listAllUsers());
		return "admin/home";
	}

	@RequestMapping("/active/{idAccount}")
	public String activateAccount(@PathVariable("idAccount") Long idAccount) {
		adminService.active(idAccount);
		return "redirect:/admin/home";
	}

	@RequestMapping("/deactivate/{idAccount}")
	public String deactivateAccount(@PathVariable("idAccount") Long idAccount) {
